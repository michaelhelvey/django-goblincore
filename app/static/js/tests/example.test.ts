...
function getExampleDOM() {
  // This is just a raw example of setting up some DOM that we can interact
  // with. Swap this with your UI framework of choice 😉
  ...
  button!.addEventListener("click", () => {
    // let's pretend this is making a server request, so it's async (you'd want
    // to mock this imaginary request in your unit tests)...
    setTimeout(
      () => {
